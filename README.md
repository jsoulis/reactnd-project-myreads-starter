...
└── src
    ...
    ├── ListBooks.js # Defines component for how books are rendered on Main page
    └── SearchPage.js #Defines searchPage component and how to add books to main page.
...
Udacity React Course provided a backend server that holds all the info for books found in this project. The provided file [`BooksAPI.js`](src/BooksAPI.js) contains the methods need to perform necessary operations on the backend:
...
This repository is forked from a version of starter code provided by Udacity.
